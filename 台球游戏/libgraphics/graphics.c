...
static void InitColors(void)
{
    ...
    DefineColor("Purple", .627,.125, .941);//
    DefineColor("Tomato", .933, .361, .259);
    DefineColor("Yellow2", .933, .933, 0);
    DefineColor("Blue3", 0, 0, .804);
    DefineColor("SpringGreen4", 0, .545, .271);
    DefineColor("SeaGreen", .18, .545, .341);
    DefineColor("CHOCOLATE", 0.55, 0.27, 0.07);
    DefineColor("FORESTGREEN", 0.13, 0.55, 0.13);
    DefineColor("TAN", 0.55, 0.41, 0.08);
    DefineColor("SIENNA", 0.42, 0.56, 0.14);
}
